...
export function About() {
  ...
  return (
    <section
      id="about"
      className="relative z-[25] bg-[#f2f1e8] pb-24 pt-16 text-neutral-950 md:pb-32 md:pt-20 darkroom:bg-[#0f0202] darkroom:text-red-100"
        ...
        <div className="flex min-h-0 flex-col gap-10 md:grid md:grid-cols-12 md:gap-x-10 md:gap-y-12">
          <aside className="min-w-0 md:col-span-5">
            <div className="md:sticky md:top-8 md:max-h-[calc(100dvh-2rem)] md:overflow-y-auto">
              <div className="relative md:-mt-8 md:-ml-4 overflow-hidden rounded-sm bg-[#f2f1e8] darkroom:bg-[#1a0505]">
                <div
                  className="pointer-events-none absolute inset-0 bg-[#f2f1e8] darkroom:bg-[#1a0505]"
                  aria-hidden
                />
                <div className="relative aspect-[4/5] w-full max-w-full">
                  <HalftoneDots
                    ...
                    colorBack={safelight ? '#1a0505' : '#f2f1e8'}
                    colorFront={safelight ? '#fca5a5' : '#2b2b2b'}
          ...
          <div className="space-y-12 md:col-span-7">
            <section aria-label="About summary">
              <p className="max-w-2xl text-4xl leading-tight tracking-tight text-neutral-800 darkroom:text-red-50/95 sm:text-5xl md:text-6xl">
            ...
            <section aria-labelledby="contact-heading">
              <h3
                id="contact-heading"
                className="mb-4 text-xs font-semibold uppercase tracking-[0.24em] text-neutral-500 darkroom:text-red-400/75"
              >
                Contact
              </h3>
              <ul className="flex flex-wrap items-center gap-3">
                <li>
                  <a
                    ...
                    className="inline-flex h-12 w-12 items-center justify-center rounded-full border border-neutral-950 text-neutral-950 transition-colors hover:bg-neutral-950 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 darkroom:border-red-500/55 darkroom:text-red-100 darkroom:hover:bg-red-950 darkroom:hover:text-red-50 darkroom:focus-visible:ring-red-400/70 darkroom:focus-visible:ring-offset-[#0f0202]"
                  >
